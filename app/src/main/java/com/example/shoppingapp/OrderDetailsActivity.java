            ...
            case "Cancelled":
                ...
                if (model.getPackedDate().after(model.getOrderedDate())){
                    ...
                    }else
                    {
                        ...
                        packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successgreen)));
                        packedDate.setText(simpleDateFormat.format(String.valueOf(model.getPackedDate())));
                ...
                }else
                {
                    ...
                    packedDate.setText(simpleDateFormat.format(String.valueOf(model.getCancelledDate())));
