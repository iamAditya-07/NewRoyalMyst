...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    @NotNull
    @Override
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ProductSpecificationAdapter.ViewHolder viewHolder, int position) {
