...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    @NotNull
    @Override
    public MyOrderAdapter.Viewholder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull MyOrderAdapter.Viewholder viewholder, int position) {
    ...
    class Viewholder extends RecyclerView.ViewHolder{
        ...
        private void setRating(int starPosition) {
            ...
            for (int x = 0;x < rateNowContainer.getChildCount();x++){
                ...
                starBtn.setImageTintList(ColorStateList.valueOf(Color.parseColor("#CED4D6")));
                if(x <= starPosition){
                    starBtn.setImageTintList(ColorStateList.valueOf(Color.parseColor("#EAF672")));
                }
            }
        }
    }
