...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void showConfirmationLayout () {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, SMS_API, new Response.Listener<String>() {
                ...
                public Map<String, String> getHeaders() throws AuthFailureError {
                    ...
                    headers.put("authorization", "Zp9GzfycS5VqC76Em20Yn3NIJdotFiOWLHw8MsPbDTvlhxeaKQCpYSTZoB9Fw4NURHbgAWt6MGn7mLPj");
                    return headers;
                }
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    body.put("message", "Thanks for shopping with us! Your order is confirmed and will be shipped shortly. Your order ID is " + order_id);
        ...
        private void paytm(){
            ...
            String M_id = "NGraap05887394564695";
            String customer_id = FirebaseAuth.getInstance().getUid();

            String url = "https://adityasinghshoppingapp.000webhostapp.com/paytm/generateChecksum.php";
                    ...
                    try {
                        ...
                        if (jsonObject.has("CHECKSUMHASH")) {
                            ...
                            paytmPGService.startPaymentTransaction(DeliveryActivity.this, true, true, new PaytmPaymentTransactionCallback() {
                                ...
                                @Override
                                public void clientAuthenticationFailed (String
                                                                                inErrorMessage){
                                ...
                                @Override
                                public void onTransactionCancel (String
                                                                         inErrorMessage, Bundle inResponse){
